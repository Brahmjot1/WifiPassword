...
import static com.prowify.wifimanager.Others.Utils.isStringNullOrEmpty;
...
import com.prowify.wifimanager.Activity.WifiAnalyserActivity;
import com.prowify.wifimanager.Activity.WifiListActivity;
import com.prowify.wifimanager.Activity.WifiPasswordActivity;
import com.prowify.wifimanager.Async.DownloadImageShareAsync;
import com.prowify.wifimanager.Model.CategoryModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppLovinSdk.initializeSdk( this, new AppLovinSdk.SdkInitializationListener() {
            ...
            public void onSdkInitialized(final AppLovinSdkConfiguration configuration)
            {
                ...
                MaxAdView adView = findViewById( R.id.adLovinBanner );
                adView.loadAd();
            }
        } );
