package com.team.wifimanager.Model;

public class RequestModel {

    private String userId,token,captchaToken,firstName,lastName,emialId,profileImage,countryCode,mobileNumber,referralUserId,referralCode,referralLink,referralLinkDate,loginType,
            deviceType,isEmailVerified,isMobileVerified,earningPoint,withdrawAamount,isActive,deviseId,adId,deviceName,deviceVersion,appVersion;
